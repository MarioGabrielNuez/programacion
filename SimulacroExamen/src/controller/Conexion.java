...
public class Conexion {
	 ...
	 */
	private static String nombreDB = "Escuela"; 
	/**
	 ...
	 */
	static Connection conexion = null; //Establecemos la conexion por defecto a null
	 ...
	 */
	public static void conect() throws SQLException, ClassNotFoundException {
		try {
